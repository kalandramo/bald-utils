...
```bash
go get -u github.com/kalandramo/bald-utils/translator/alibaba
```
...
import (
	"fmt"
	"log"
	"github.com/kalandramo/bald-utils/translator/alibaba"
)
...
- [项目主页](https://github.com/kalandramo/bald-utils)
